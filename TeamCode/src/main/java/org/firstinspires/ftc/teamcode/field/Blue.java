...
public class Blue {
    ...
    public static final Pose PICKUP1_POSE = new Pose(17, 84, Math.toRadians(0)); //og = 24, 84
    ...
    public static final Pose PICKUP2_POSE = new Pose(17, 60, Math.toRadians(0)); // og = 24, 60
    ...
    public static final Pose PICKUP3_POSE = new Pose(17, 36, Math.toRadians(0)); // og: 24, 36
    // Teleop
    // Gate Start & End
