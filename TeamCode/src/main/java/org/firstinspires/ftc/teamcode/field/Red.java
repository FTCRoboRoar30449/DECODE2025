...
public class Red {
    ...
    public static final Pose ALIGN1_POSE = new Pose(101.5, 36, Math.toRadians(180));
    public static final Pose PICKUP1_POSE = new Pose(119.5, 36, Math.toRadians(180));

    // Middle (Second Set) of Artifacts from the Spike Mark.
    public static final Pose READY2_POSE = new Pose(98.5,60, Math.toRadians(180));
    public static final Pose ALIGN2_POSE = new Pose(101.5, 60, Math.toRadians(180));
    public static final Pose PICKUP2_POSE = new Pose(119.5, 60, Math.toRadians(180));

    // Lowest (Last Set) of Artifacts from the Spike Mark.
    public static final Pose READY3_POSE = new Pose(94,84, Math.toRadians(180));
    public static final Pose ALIGN3_POSE = new Pose(101.5, 84, Math.toRadians(180));
    public static final Pose PICKUP3_POSE = new Pose(119.5, 84, Math.toRadians(180));
