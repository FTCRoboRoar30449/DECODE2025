...
public class Red {
    ...
    public static final Pose APRILTAG_POSE_NEAR_READ = new Pose(82,80.5, Math.toRadians(80));
    ...
    public static final Pose READY_NEAR_POSE = new Pose(94,84, Math.toRadians(180));
